...
\newcommand\Tkw[1]{\ensuremath{\mathtt{#1}}}
\newcommand\Ekw[1]{\ensuremath{\mathtt{#1}}}
\newcommand\Econst[1]{\ensuremath{\mathtt{#1}}}
...
\newcommand\ActLetBeta{Act-LetBeta}
\newcommand\ActLet{Act-Let}
\newcommand\ActLetPair{Act-LetPair}
\newcommand\ActSync{Act-Sync}
...
\newcommand\typingI[3][\Ctxt]{#1 \vdash\tyIso #2 : #3}
...
\newcommand\eqsctxt{\Sigma}
\newcommand\eqsrel[4][\eqsctxt]{#1 \vdash \convexpr{#2} : #3 \eqs #4}
\newcommand\eqscorel[4][\eqsctxt]{\vdash #3 \eqs #4}
\newcommand\convcolor{\color{blue!50}}
\newcommand\convexpr[1]{{\convcolor #1}}
...
\newcommand\convertmany[3][]{#2 \stackrel{#1}{\Leftrightarrow} #3}
