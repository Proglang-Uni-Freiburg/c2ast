...
\newcommand\ELetU[1]{\ELet{\EUnit}{#1}}
\newcommand\ELetP[3]{\ELet{(#1,#2)}{#3}}
\newcommand\EkwWait{\Econst{wait}}
\newcommand\EkwTerm{\Econst{terminate}}
\newcommand\EkwSend{\Econst{send}}
\newcommand\EkwRecv{\Econst{recieve}}
\newcommand\EkwSelect{\Econst{select}}
...
\newcommand\ECase[2]{\EkwCase\; #1 \; \Ekw{of} \; \{\, #2 \,\}}
