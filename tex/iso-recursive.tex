...
\end{mathpar}
%
and we replace the typing rule for conversion by a rule for explicit
unrolling.
\begin{mathpar}
    \inferrule{
      \typing{e}{\TRec S}
...
$f : T \eqt T'$ gives rise to a function $f : \TFun {T} {T'}$.
% , $f' : \TFun {T'} {T}$.
Equivalence of session types $g : S \eqs S' : g'$ gives rise
to a function $g : \TFun {\TPair {S} {\TDual{S'}}} \TUnit$.
% and $g' : \TFun {\TPair {S'} {\TDual{S}}} \TUnit$.
